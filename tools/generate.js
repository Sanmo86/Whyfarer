...
const V = '20260913c'; // cache-buster — bump on every deploy
...
const STRINGS = {
  en: {
    ...
    desc: 'Twenty-six customs, beliefs, and cultural quirks from around the world, explained calmly: why they exist, and what they reveal about the people who live them.',
    categories: { europe: 'Europe', asia: 'Asia', americas: 'Americas', africa: 'Africa' },
    navHome: 'Home', navArchive: 'Archive',
    issue: 'Issue No. 1 · 2026', issueSub: '26 customs · 26 countries',
    ...
    ctaDek: 'The full archive gathers all 26 customs grouped by continent, ready to browse like a magazine.',
    ...
    archiveTitle: 'All 26 customs, country by country',
    ...
    footerTagline: 'A magazine of world curiosities. Twenty-six whys, told calmly, one country at a time.',
  ...
  es: {
    ...
    desc: 'Veintiséis costumbres, creencias y rarezas culturales del mundo, explicadas con calma: por qué existen y qué dicen de quienes las viven.',
    categories: { europe: 'Europa', asia: 'Asia', americas: 'América', africa: 'África' },
    navHome: 'Inicio', navArchive: 'Archivo',
    issue: 'Edición N.º 1 · 2026', issueSub: '26 costumbres · 26 países',
    ...
    ctaDek: 'El archivo completo reúne las 26 costumbres agrupadas por continente, listas para hojear como una revista.',
    ...
    archiveTitle: 'Las 26 costumbres, país por país',
    ...
    footerTagline: 'Revista de curiosidades culturales del mundo. Veintiséis porqués, contados con calma, un país a la vez.',
