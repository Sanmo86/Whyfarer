...
const STRINGS = {
  en: {
    ...
    desc: `Customs, beliefs, and cultural quirks from around the world, explained calmly: why they exist, and what they reveal about the people who live them.`,
    ...
    ctaDek: `The full archive gathers every custom grouped by continent, ready to browse like a magazine.`,
    ...
    archiveTitle: `All our customs, country by country`,
    ...
    footerTagline: `A magazine of world curiosities. Every why, told calmly, one country at a time.`,
  ...
  es: {
    ...
    desc: `Costumbres, creencias y rarezas culturales del mundo, explicadas con calma: por qué existen y qué dicen de quienes las viven.`,
    ...
    ctaDek: `El archivo completo reúne todas las costumbres agrupadas por continente, listas para hojear como una revista.`,
    ...
    archiveTitle: `Todas nuestras costumbres, país por país`,
    ...
    footerTagline: `Revista de curiosidades culturales del mundo. Cada porqué, contado con calma, un país a la vez.`,
