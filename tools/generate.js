...
const V = '20260913d'; // cache-buster — bump on every deploy
const COUNT = META.length; // total published articles — drives every "N customs / N countries" mention below, so publishing one more never means hunting down a hardcoded number again
...
const STRINGS = {
  en: {
    ...
    desc: `${COUNT} customs, beliefs, and cultural quirks from around the world, explained calmly: why they exist, and what they reveal about the people who live them.`,
    categories: { europe: 'Europe', asia: 'Asia', americas: 'Americas', africa: 'Africa' },
    navHome: 'Home', navArchive: 'Archive',
    issue: 'Issue No. 1 · 2026', issueSub: 'Customs · Countries',
    ...
    ctaDek: `The full archive gathers all ${COUNT} customs grouped by continent, ready to browse like a magazine.`,
    ...
    archiveTitle: `All ${COUNT} customs, country by country`,
    ...
    footerTagline: `A magazine of world curiosities. ${COUNT} whys, told calmly, one country at a time.`,
  ...
  es: {
    ...
    desc: `${COUNT} costumbres, creencias y rarezas culturales del mundo, explicadas con calma: por qué existen y qué dicen de quienes las viven.`,
    categories: { europe: 'Europa', asia: 'Asia', americas: 'América', africa: 'África' },
    navHome: 'Inicio', navArchive: 'Archivo',
    issue: 'Edición N.º 1 · 2026', issueSub: 'Costumbres · Países',
    ...
    ctaDek: `El archivo completo reúne las ${COUNT} costumbres agrupadas por continente, listas para hojear como una revista.`,
    ...
    archiveTitle: `Las ${COUNT} costumbres, país por país`,
    ...
    footerTagline: `Revista de curiosidades culturales del mundo. ${COUNT} porqués, contados con calma, un país a la vez.`,
